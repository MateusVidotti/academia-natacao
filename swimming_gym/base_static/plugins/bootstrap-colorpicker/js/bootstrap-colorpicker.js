...
var ColorItem = function () {
  ...
  _createClass(ColorItem, [{
     ...
     * Hue formulas can be extended using ColorItem.colorFormulas base_static property.
     *
...
// model conversion methods and base_static constructors
Object.keys(convert).forEach(function (model) {
	...
	// 'base_static' construction methods
